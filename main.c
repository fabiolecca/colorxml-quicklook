...
#define PLUGIN_ID "D8225D24-4581-443C-B5A5-CA6E38C76AC3"
...
printf("AllocQuickLookGeneratorPluginType");
...
printf("DeallocQuickLookGeneratorPluginType");
...
printf("QuickLookGeneratorQueryInterface");
...
ULONG QuickLookGeneratorPluginAddRef(void *thisInstance)
{
printf("QuickLookGeneratorPluginAddRef");
...
ULONG QuickLookGeneratorPluginRelease(void *thisInstance)
{
printf("QuickLookGeneratorPluginRelease");
...
printf("QuickLookGeneratorPluginFactory");
